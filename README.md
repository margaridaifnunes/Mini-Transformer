...
Questões para a aula prática:
  ...
  -> justificar quantyas instruções suporta o nosso processador consoante as difinições da ROM; +ROM -> + TAMANHO DE PC; + RAM -> + tamanho do chip ( + preço); porque o tamanho de rom? e cosnequentemente pk o tamanho do contador?  extensibilidade: se fosso adicionar um jump o que teriamos de alterar?? (dar um exemplo) jump fica limitado pelo contador; e se fosse um jal? mais que 16 é mau para fazer jumps; menos que 256 é poucas isntruções...
  Impacto da ROM: 
